...
length(unique(beetle_env[["Plot"]]))


#viereck classes within 
beetle_vascular_perm <- adonis2(beetle_composition ~ Viereck.3 + Park + Plot + Visit + Viereck.3*Visit, 
                                data = beetle_env, method = "bray", 
                                permutations = perm_design_beetle_time, 
                                by = "terms")
print(beetle_vascular_perm)
...
#viereck classes within 
beetle_lichen_perm <- adonis2(beetle_lichen_composition ~ Viereck.3 + Park + Plot + Visit + Viereck.3*Visit, 
                                data = lichens_env_beetle, method = "bray", 
                                permutations = perm_design_beetle_lichen_time, 
                                by = "terms")
print(beetle_lichen_perm)
...
#viereck classes within 
beetle_nonvasc_perm <- adonis2(beetle_nonvasc_composition ~ Viereck.3 + Park + Plot + Visit + Viereck.3*Visit, 
                                data = nonvasc_env_beetle, method = "bray", 
                                permutations = perm_design_beetle_nonvasc_time, 
                                by = "terms")
...
length(unique(nonvasc_env_beetle[["Plot"]]))
length(unique(lichens_env_beetle[["Plot"]]))
