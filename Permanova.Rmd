...
#Optional, if interested in how I balanced the subsets 
...
## Building the dataframes to be balanced - code used, for reference 
```{r}
#Vascular 
...
```{r}
write_xlsx(beetle_env, "T:/Users/KPace/SWAN-Internship-New/Data/Modified/PERMANOVA_DF_QuickLoad/beetle_env.xlsx")
write_xlsx(beetle_env, "T:/Users/KPace/SWAN-Internship-New/Data/Modified/PERMANOVA_DF_QuickLoad/beetle_env_lichen.xlsx")
write_xlsx(beetle_env, "T:/Users/KPace/SWAN-Internship-New/Data/Modified/PERMANOVA_DF_QuickLoad/beetle_env_nonvasc.xlsx")
```
...
## Create composition matrices, and restrict permutations for PERMANOVA 
```{r}
#Vascular 
...
#Lichen 
beetle_lichen_composition <- beetle_df_lichen[,c(13:178)]
...
#Nonvascular 
beetle_nonvasc_composition <- beetle_df_nonvasc[,c(13:218)]
...
#species frequency - just time added, no interaction 
  ...
  #time as a continuous predictor  
      beetle_multivariate_year <- adonis2(beetle_composition ~ Park + Plot + Visit, 
                                          data = beetle_env, method = "bray", 
                                          permutations = perm_design_beetle_time, 
                                          by = "terms")
...
#multivariate (Species Frequency)
    ...
    #time for rest of table 
          #species richness 
          beetle_lichen_univariate_visit <- adonis2(beetle_env_lichen$Species_Richness ~ Park + Plot + Visit,
                                                         data = beetle_env_lichen, 
                                                         method = "euclidian",
          ...
          #species frequency 
          beetle_lichen_multivariate_visit <- adonis2(beetle_lichen_composition ~ Park + Plot + Visit, 
                                                     data = beetle_env_lichen, method = "bray", 
                                                     permutations = perm_design_beetle_lichen_time, 
                                                     by = "terms")
          ...
          #canopy cover effects on frequency 
          beetle_CC_multivariate_lichen <- adonis2(beetle_lichen_composition ~ Percent_Cover + Park + Plot + Visit, 
                                                   data = beetle_env_lichen, method = "bray", 
                                                   permutations = perm_design_beetle_lichen_time, 
                                                   by = "terms")
          ...
          #viereck subclasses
          beetle_lichen_subclass <- adonis2(beetle_lichen_composition ~ Viereck.3 + Park + Plot + Visit + Viereck.3*Visit, 
                                        data = beetle_env_lichen, method = "bray", 
                                        permutations = perm_design_beetle_lichen_time, 
                                        by = "terms")
...
#Nonvascular 
          #base park model 
          beetle_univariate <- adonis2(beetle_env_nonvasc$Species_Richness ~ Park + Plot,
...
#Visit model 
          beetle_nonvasc_univariate_visit <- adonis2(beetle_env_nonvasc$Species_Richness ~ Park + Plot + Visit,
                                                          data = beetle_env_nonvasc, 
                                                          method = "euclidian",
          ...
          beetle_nonvasc_multivariate_visit <- adonis2(beetle_nonvasc_composition ~ Park + Plot + Visit, 
                                                      data = beetle_env_nonvasc, method = "bray", 
                                                      permutations = perm_design_beetle_nonvasc_time, 
                                                      by = "terms")
...
#canopy cover effects on frequency 
          beetle_CC_nonvasc <- adonis2(beetle_nonvasc_composition ~ Percent_Cover + Park + Plot + Visit, 
                                                    data = beetle_env_nonvasc, method = "bray", 
                                                    permutations = perm_design_beetle_nonvasc_time, 
                                                    by = "terms")
          beetle_CC_nonvasc 
...
#Quick load of dataframes from T drive
    needle_df <- read_xlsx("T:/Users/KPace/SWAN-Internship-New/Data/Modified/PERMANOVA_DF_QuickLoad/needle_df.xlsx")
...
## Creating the env files, composition matrices, and restricting permutations for PERMANOVA 
```{r}
#Vascular 
...
#vascular 
          ...
          needle_result_timecross3 <- adonis2(needle_composition ~ Park + Plot + Visit + Park*Visit, 
                                              data = needle_env, method = "bray", 
                                              permutations = perm_design_needle_time, 
                                              by = "margin")
          needle_result_timecross3
...
```{r}
#quick pull from T drive 
openlow_df <- read_xlsx("T:/Users/KPace/SWAN-Internship-New/Data/Modified/PERMANOVA_DF_QuickLoad/openlow_df.xlsx")
...
```{r}
#Vascular 
      openlow_composition <- openlow_df[,c(9:281)]
...
#Lichen 
      openlow_composition_lichen <- openlow_df_lichen[,c(13:178)]
...
#Nonvascular 
      openlow_composition_nonvasc <- openlow_df_nonvasc[,c(13:218)]
...
#Species richness (Univariate)
      check(openlow_env, control = perm_design_openlow) #check how many possible permutations - to catch obvious error in structure 
       ...
       #initial model for most of table
      ...
      #create permutation object 
      perms_19 <- rbind(1:nrow(openlow_env),
...
#species frequency (multivariate)
      ...
      openlow_univariate_timecross2 <- adonis2(openlow_env$Species_Richness ~ Park + Plot + Visit + Park*Visit,
                                               ...
                                               by = "terms")
      print(openlow_univariate_timecross2)
      ...
      openlow_result_timecross2 <- adonis2(openlow_composition ~ Park + Plot + Visit + Park*Visit, 
                                           ...
                                           permutations = perm_design_openlow_time, 
                                           by = "terms")
      print(openlow_result_timecross2)
...
#quick Load from T drive 
  dwarfscrub_df <- read_xlsx("T:/Users/KPace/SWAN-Internship-New/Data/Modified/PERMANOVA_DF_QuickLoad/dwarfscrub_df.xlsx")
...
## Building the dataframes to be balanced, code for reference 
```{r}
#vascular 
...
#vascular 
          ...
          #by terms 
          dwarfscrub_vascular_terms <- adonis2(dwarfscrub_composition ~ Viereck.3 + Park + Plot + Visit + Viereck.3*Visit, 
                                               data = dwarfscrub_env, method = "bray", 
                                               permutations = perm_design_dwarfscrub_time, 
                                               by = "terms")
          print(dwarfscrub_vascular_terms)
          
          
          #by margin 
          dwarfscrub_vascular_margin <- adonis2(dwarfscrub_composition ~ Viereck.3 + Park + Plot + Visit + Viereck.3*Visit, 
                                                data = dwarfscrub_env, method = "bray", 
                                                permutations = perm_design_dwarfscrub_time, 
                                                by = "margin") 
          print(dwarfscrub_vascular_margin)
...
#Lichen 
          ### Univariate 
          check(dwarfscrub_env_lichens, control = perm_design_dwarfscrub_lichen) #how many possible permutations 
          ...
          #create permutation object 
          perms17 <- rbind(1:nrow(dwarfscrub_env_lichen),
          ...
          #loop 
          for (i in 1:nrow(perms17)) {
            temp.data <- dwarfscrub_env_lichen[perms17[i, ], ]
          ...
          ### Multivariate 
          dwarfscrub_result_lichen <- adonis2(dwarfscrub_composition_lichen ~ Park + Plot, 
                                               data = dwarfscrub_env_lichen, method = "bray", 
                                               permutations = perm_design_dwarfscrub_lichen, 
                                               by = "terms")
          dwarfscrub_result_lichen
          
          #create permutation structure and results object 
          perms18 <- rbind(1:nrow(dwarfscrub_composition_lichen),
          ...
          #loop 
          for (i in 1:nrow(perms18)) {
            temp.data <- dwarfscrub_env_lichen[perms18[i, ], ]
          ...
          #based on visit 
          dwarfscrub_univariate_timecross2_lichen <- adonis2(dwarfscrub_env_lichen$Species_Richness ~ Park + Plot + Visit + Park*Visit,
                                                              data = dwarfscrub_env_lichen, 
                                                              method = "euclidian",
                                                              permutations = perm_design_dwarfscrub_time_lichen,
                                                              by = "terms")
          dwarfscrub_univariate_timecross2_lichen
          
          dwarfscrub_result_timecross2_lichen <- adonis2(dwarfscrub_composition_lichen ~ Park + Plot + Visit + Park*Visit, 
                                                          data = dwarfscrub_env_lichen, method = "bray", 
                                                          permutations = perm_design_dwarfscrub_time_lichen, 
                                                          by = "terms")
          dwarfscrub_result_timecross2_lichen
          
          
          #viereck classes within 
          dwarfscrub_vascular_perm_lichen <- adonis2(dwarfscrub_composition_lichen ~ Viereck.3 + Park + Plot + Visit + Viereck.3*Visit, 
                                                      data = dwarfscrub_env_lichen, method = "bray", 
                                                      permutations = perm_design_dwarfscrub_time_lichen, 
                                                      by = "terms")
          print(dwarfscrub_vascular_perm_lichen)
...
```{r}
#quick load from T Drive 
    forest_df <- read_xlsx("T:/Users/KPace/SWAN-Internship-New/Data/Modified/PERMANOVA_DF_QuickLoad/forest_df.xlsx")
...
#lichen 
          ...
          forest_env_lichen <- forest_df_lichen[,c(1:11)]
...
#lichen 
          ...
          forest_univariate_lichen <- adonis2(forest_env_lichen$Species_Richness ~ Park + Plot,
                                               ...
                                               by = "terms")
          forest_univariate_lichen
          
          #create permutation object 
          perms21 <- rbind(1:nrow(forest_env_lichen),
          ...
          #loop 
          for (i in 1:nrow(perms21)) {
            temp.data <- forest_env_lichen[perms21[i, ], ]
          ...
          ### Multivariate - species composition 
          forest_result_lichens <- adonis2(forest_composition_lichen ~ Park + Plot, 
          ...
          #create permutation structure and results object 
          perms22 <- rbind(1:nrow(forest_composition_lichen),
          ...
          #loop 
          for (i in 1:nrow(perms22)) {
            temp.data <- forest_env_lichen[perms22[i, ], ]
          ...
          #based on visit - time for rest of table 
          forest_univariate_timecross2_lichen <- adonis2(forest_env_lichen$Species_Richness ~ Park + Plot + Visit,
                                                          data = forest_env_lichen, 
                                                          method = "euclidian",
                                                          permutations = perm_design_forest_time_lichen,
                                                          by = "terms")
          forest_univariate_timecross2_lichen
          
          forest_result_timecross2_lichens <- adonis2(forest_composition_lichen ~ Park + Plot + Visit, 
                                                      data = forest_env_lichen, method = "bray", 
                                                      permutations = perm_design_forest_time_lichen, 
                                                      by = "terms")
          forest_result_timecross2_lichen
          
          
          
          #viereck classes within - open and closed canopy 
          forest_vascular_perm_lichen <- adonis2(forest_composition_lichen ~ Viereck.3 + Park + Plot + Visit + Viereck.3*Visit, 
                                                  data = forest_env_lichen, method = "bray", 
                                                  permutations = perm_design_forest_time_lichen, 
                                                  by = "terms")
          print(forest_vascular_perm_lichen)
