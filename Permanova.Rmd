...
## Creating the env files, code for reference 
```{r}
#Vascular
...
## Calculate Species Richness Averages and Standard Error 
```{r}
#beetle kill
        beetle_env %>%
          group_by(Park) %>%
...
#species frequency (multivariate)
      openlow_multivariate <- adonis2(openlow_composition ~ Park + Plot, 
                                data = openlow_env, method = "bray", 
                                permutations = perm_design_openlow, 
                                by = "terms")
      print(openlow_multivariate)
...
#Vascular 
  ...
  ### Multivariate (species frequency)
          #base model 
          dwarfscrub_multivariate <- adonis2(dwarfscrub_composition ~ Park + Plot, 
                                       data = dwarfscrub_env, method = "bray", 
                                       permutations = perm_design_dwarfscrub, 
                                       by = "terms")
          print(dwarfscrub_multivariate)
...
write_xlsx(forest_env, "T:/Users/KPace/SWAN-Internship-New/Data/Modified/PERMANOVA_DF_QuickLoad/forest_env_vasc.xlsx")
```
...
```{r}
#Vascular 
          forest_composition <- forest_df[,c(9:281)]
...
#Lichen 
          forest_composition_lichen <- forest_df_lichen[,c(13:178)]
...
#Vascular 
    ...
    ### Multivariate - species frequency 
          #base model 
          forest_multivariate <- adonis2(forest_composition ~ Park + Plot, 
                                   data = forest_env, method = "bray", 
                                   permutations = perm_design_forest, 
                                   by = "terms")
          print(forest_multivariate)
