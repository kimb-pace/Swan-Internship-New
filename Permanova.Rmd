...
#Optional (Can avoid if using quickload within subsets)
    ...
    #If interested in how I balanced the subsets and built the .env files
      ...
      lichen_sp_richness <- read_xlsx("T:/Users/KPace/SWAN-Internship-New/Data/Modified/Collapsed_Species_Code_DFs/Lichen_Species_Richness.xlsx")
      nonvasc_sp_richness <- read_xlsx("T:/Users/KPace/SWAN-Internship-New/Data/Modified/Collapsed_Species_Code_DFs/Nonvascular_Species_Richness.xlsx")
      vasc_sp_richness <- read_xlsx("T:/Users/KPace/SWAN-Internship-New/Data/Modified/Collapsed_Species_Code_DFs/Vascular_Species_Richness.xlsx")
```
...
#Lichen 
  ...
  ### Multivariate (species frequency)
    ...
    #differences between subclasses
      ...
      #calculate F statistic for viereck class
          results022 <- results022 |>
            data.frame() |>
            mutate(F.Viereck = (Viereck.3/2)/(Plot/13))
          head022 <- head(results022)
...
#nonvascular 
  ...
  ### Multivariate (Species frequency)
    ...
    #differences between subclasses 
          ...
          #calculate F statistic for viereck 
          results024 <- results024 |>
            data.frame() |>
            mutate(F.Viereck = (Viereck.3/2)/(Plot/13))
          head024 <- head(results024)
    ...
    #time based models 
     ...
     #subclass models 
          ...
          forest_vascular_univariate_subclass_nonvasc <- 
            adonis2(forest_env_nonvasc$Species_Richness ~ Viereck.3 + Park + Plot + 
                      Sample_Year + Viereck.3*Sample_Year, 
                                                  data = forest_env_nonvasc, method = "bray", 
                                                  permutations = perm_design_forest_time_nonvasc, 
                                                  by = "terms")
