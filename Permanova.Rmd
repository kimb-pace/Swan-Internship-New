...
#Differences between subclasses
    #univariate (Species richness)
      ...
      perms01 <- rbind(1:nrow(beetle_env),
                      shuffleSet(n = nrow(beetle_env), control = perm_design_beetle_time, nset = 999))
...
#multivariate 
  ...
  #differences between subclasses
      ...
      perms02 <- rbind(1:nrow(beetle_composition),
                      shuffleSet(n = nrow(beetle_composition), control = perm_design_beetle_time, nset = 999))
...
#Differences between subclasses 
          ...
          #create permutation object 
          perms3 <- rbind(1:nrow(beetle_env_lichen),
                          shuffleSet(n = nrow(beetle_env_lichen), control = perm_design_beetle_lichen_time, nset = 999))
          
          #create object for Ss to be stored 
          results3 <- matrix(nrow = nrow(perms3), ncol = 7)
          colnames(results3) <- c("Viereck.3", "Park", "Plot", "Sample_Year", "Viereck.3*Sample_Year", "Residual", "Total")
...
#multivariate (Species Frequency)
    ...
    #differences between parks 
      ...
      #differences between subclasses 
          ...
          #create permutation structure and results object 
          perms4 <- rbind(1:nrow(beetle_lichen_composition),
                          shuffleSet(n = nrow(beetle_lichen_composition), control = perm_design_beetle_lichen_time, nset = 999))
          results4 <- matrix(nrow = nrow(perms4), ncol = 7)
          colnames(results4) <- c("Viereck.3", "Park", "Plot", "Sample_Year", "Viereck.3*Sample_Year", "Residual", "Total")
...
#Nonvascular 
  ...
  #Differences between subclasses 
          ...
          perms05 <- rbind(1:nrow(beetle_env_nonvasc),
                          shuffleSet(n = nrow(beetle_env_nonvasc), control = perm_design_beetle_nonvasc_time, nset = 999))
...
#multivariate - species frequency 
  ...
  #differences between subclasses 
          ...
          perms06 <- rbind(1:nrow(beetle_nonvasc_composition),
                          shuffleSet(n = nrow(beetle_nonvasc_composition), control = perm_design_beetle_nonvasc_time, nset = 999))
          results06 <- matrix(nrow = nrow(perms06), ncol = 7)
          colnames(results06) <- c("Viereck.3", "Park", "Plot", "Sample_Year", "Viereck.3*Sample_Year", "Residual", "Total")
  ...
  #species richness 
    ...
    #Differences through time 
          ...
          needle_univariate_lichen_time <- adonis2(needle_env_lichen$Species_Richness ~ Park + Plot + Sample_Year + Park*Sample_Year,
                                              data = needle_env_lichen, 
                                              method = "euclidian",
                                              permutations = perm_design_needle_lichen_time,
                                              by = "terms")
          print(needle_univariate_lichen_time)
          
          #create permutation object 
          perms09 <- rbind(1:nrow(needle_env_lichen),
                           shuffleSet(n = nrow(needle_env_lichen), control = perm_design_needle_lichen_time, nset = 999))
...
### Multivariate 
      ...
      #differences through time 
          ...
          perms010 <- rbind(1:nrow(needle_composition_lichen),
                           shuffleSet(n = nrow(needle_composition_lichen), control = perm_design_needle_lichen_time, nset = 999))
  ...
  #species richness 
    ...
    #Differences through time 
          ...
          needle_univariate_nonvasc_time <- adonis2(needle_env_nonvasc$Species_Richness ~ Park + 
                                               ...
                                               data = needle_env_nonvasc, 
                                               method = "euclidian",
                                               permutations = perm_design_needle_nonvasc_time,
                                               by = "terms")
          print(needle_univariate_nonvasc_time)
          
          #create permutation object 
          perms011 <- rbind(1:nrow(needle_env_nonvasc),
                           shuffleSet(n = nrow(needle_env_nonvasc), control = perm_design_needle_nonvasc_time, nset = 999))
  ...
  ### Multivariate - species frequency 
    ...
    #differences through time 
          ...
          perms012 <- rbind(1:nrow(needle_composition_nonvasc),
                           shuffleSet(n = nrow(needle_composition_nonvasc), control = perm_design_needle_nonvasc_time, nset = 999))
...
#Lichen 
  ...
  #Differences through time  
      ...
      openlow_univariate_lichen_time <- adonis2(openlow_env_lichen$Species_Richness ~ Park + Plot + Sample_Year + Park*Sample_Year,
                                    data = openlow_env_lichen, 
                                    method = "euclidian",
                                    permutations = perm_design_openlow_lichen_time,
                                    by = "terms")
      ...
      perms015 <- rbind(1:nrow(openlow_env_lichen),
                       shuffleSet(n = nrow(openlow_env_lichen), control = perm_design_openlow_lichen_time, nset = 999))
  ...
  #differences through time 
      ...
      perms016 <- rbind(1:nrow(openlow_composition_lichen),
                       shuffleSet(n = nrow(openlow_composition_lichen), control = perm_design_openlow_lichen_time, nset = 999))
...
#Nonvascular 
  ...
  #Differences through time  
      ...
      openlow_univariate_nonvasc_time <- adonis2(openlow_env_nonvasc$Species_Richness ~ Park + Plot + Sample_Year + Park*Sample_Year,
                                           data = openlow_env_nonvasc, 
                                           method = "euclidian",
                                           permutations = perm_design_openlow_nonvasc_time,
                                           by = "terms")
      ...
      #create permutation object 
          perms017 <- rbind(1:nrow(openlow_env_nonvasc),
                       shuffleSet(n = nrow(openlow_env_nonvasc), control = perm_design_openlow_nonvasc_time, nset = 999))
  ...
  #differences through time 
      ...
      #create permutation structure and results object 
          perms018 <- rbind(1:nrow(openlow_composition_nonvasc),
                           shuffleSet(n = nrow(openlow_composition_nonvasc), control = perm_design_openlow_nonvasc_time, nset = 999))
...
#Lichen 
    ...
    #Differences between subclasses  
          ...
          dwarfscrub_univariate_lichen_subclass <- adonis2(dwarfscrub_env_lichen$Species_Richness ~ Viereck.3 + Park + 
                                                   ...
                                                   data = dwarfscrub_env_lichen, 
                                                   method = "euclidian",
                                                   permutations = perm_design_dwarfscrub_lichen_time,
                                                   by = "terms")
          print(dwarfscrub_univariate_lichen_subclass)
          
          #create permutation object 
          perms021 <- rbind(1:nrow(dwarfscrub_env_lichen),
                           shuffleSet(n = nrow(dwarfscrub_env_lichen), control = perm_design_dwarfscrub_lichen_time, nset = 999))
    ...
    #differences between subclasses
          ...
          perms022 <- rbind(1:nrow(dwarfscrub_composition_lichen),
                           shuffleSet(n = nrow(dwarfscrub_composition_lichen), 
                                      control = perm_design_dwarfscrub_lichen_time, nset = 999))
          #head(perms18)
...
#nonvascular 
    ...
    #differences between subclasses  
          ...
          dwarfscrub_univariate_nonvasc_subclass <- adonis2(dwarfscrub_env_nonvasc$Species_Richness ~ Viereck.3 + 
                                                   ...
                                                   data = dwarfscrub_env_nonvasc, 
                                                   method = "euclidian",
                                                   permutations = perm_design_dwarfscrub_nonvasc_time,
                                                   by = "terms")
          ...
          perms023 <- rbind(1:nrow(dwarfscrub_env_nonvasc),
                           shuffleSet(n = nrow(dwarfscrub_env_nonvasc), control = perm_design_dwarfscrub_nonvasc_time, nset = 999))
  ...
  ### Multivariate (Species frequency)
    ...
    #differences between subclasses 
          ...
          perms024 <- rbind(1:nrow(dwarfscrub_composition_nonvasc),
                           shuffleSet(n = nrow(dwarfscrub_composition_nonvasc), 
                                      control = perm_design_dwarfscrub_nonvasc_time, nset = 999))
          #head(perms18)
  ...
  #species richness (univariate)
    ...
    #differences between subclasses 
          ...
          forest_univariate_lichen_subclass <- adonis2(forest_env_lichen$Species_Richness ~ Viereck.3 + Park + 
                                               ...
                                               data = forest_env_lichen, 
                                               method = "euclidian",
                                               permutations = perm_design_forest_lichen_time,
                                               by = "terms")
          print(forest_univariate_lichen_subclass)
          
          #create permutation object 
          perms027 <- rbind(1:nrow(forest_env_lichen),
                           shuffleSet(n = nrow(forest_env_lichen), control = perm_design_forest_lichen_time, nset = 999))
  ...
  ### Multivariate - species frequency 
    ...
    #differences between subclasses 
          ...
          perms028 <- rbind(1:nrow(forest_composition_lichen),
                           shuffleSet(n = nrow(forest_composition_lichen), control = perm_design_forest_lichen_time, nset = 999))
...
#nonvascular 
  #species richness (univariate)
      #differences between parks 
       ...
       #differences between subclasses
          ...
          forest_univariate_nonvasc_subclass <- adonis2(forest_env_nonvasc$Species_Richness ~ Viereck.3 + Park + 
                                               ...
                                               data = forest_env_nonvasc, 
                                               method = "euclidian",
                                               permutations = perm_design_forest_nonvasc_time,
                                               by = "terms")
          print(forest_univariate_nonvasc_subclass)
          
          #create permutation object 
          perms029 <- rbind(1:nrow(forest_env_nonvasc),
                           shuffleSet(n = nrow(forest_env_nonvasc), control = perm_design_forest_nonvasc_time, nset = 999))
    ...
    #differences between subclasses 
          #base model
          forest_result_nonvasc_subclass <- adonis2(forest_composition_nonvasc ~ Viereck.3 + Park + 
                                                      Plot + Sample_Year + Viereck.3*Sample_Year, 
                                           data = forest_env_nonvasc, method = "bray", 
                                           permutations = perm_design_forest_nonvasc_time, 
                                           by = "terms")
          ...
          perms030 <- rbind(1:nrow(forest_composition_nonvasc),
                           shuffleSet(n = nrow(forest_composition_nonvasc), control = perm_design_forest_nonvasc_time, nset = 999))
...
#Lichen 
            alpine_env_lichen <- alpine_df_lichen[,c(1:12)]
...
#Nonvascular 
            ...
            alpine_env_nonvasc <- alpine_df_nonvasc[,c(1:12)]
...
alpine_env <- read_xlsx("T:/Users/KPace/SWAN-Internship-New/Data/Modified/PERMANOVA_DF_QuickLoad/alpine_env_vasc.xlsx")
alpine_env_lichen <- read_xlsx("T:/Users/KPace/SWAN-Internship-New/Data/Modified/PERMANOVA_DF_QuickLoad/alpine_env_lichen.xlsx")
alpine_env_nonvasc <- read_xlsx("T:/Users/KPace/SWAN-Internship-New/Data/Modified/PERMANOVA_DF_QuickLoad/alpine_env_nonvasc.xlsx")
```
  ...
  #Differences between Parks - subclass model 
      ...
      #create permutation framework + results object 
          perms32 <- rbind(1:nrow(alpine_env),
                         shuffleSet(n = nrow(alpine_env), control = perm_design_alpine_time, nset = 999))
          results32 <- matrix(nrow = nrow(perms32), ncol = 7)
          colnames(results32) <- c("Viereck.3", "Park", "Plot", "Sample_Year", "Viereck.3*Sample_Year", "Residual", "Total")
  ...
  #subclass model 
      ...
      #create permutation framework + results object 
          perms34 <- rbind(1:nrow(alpine_composition),
                shuffleSet(n = nrow(alpine_composition), control = perm_design_alpine_time, nset = 999))
          results34 <- matrix(nrow = nrow(perms34), ncol = 7)
          colnames(results34) <- c("Viereck.3", "Park", "Plot", "Sample_Year", "Viereck.3*Sample_Year", "Residual", "Total")
...
### Univariate park 
         ...
         #difference between subclasses 
                ...
                perms36 <- rbind(1:nrow(alpine_env_lichen),
                               shuffleSet(n = nrow(alpine_env_lichen), control = perm_design_alpine_lichen_time, nset = 999))
                
                #create object for Ss to be stored 
                results36 <- matrix(nrow = nrow(perms36), ncol = 7)
                colnames(results36) <- c("Viereck.3", "Park", "Plot", "Sample_Year", 
...
### Multivariate - presence absence composition 
      ...
      #subclass model 
                ...
                perms38 <- rbind(1:nrow(alpine_lichen_composition),
                                shuffleSet(n = nrow(alpine_lichen_composition), control = perm_design_alpine_lichen_time, nset = 999))
                
                results38 <- matrix(nrow = nrow(perms38), ncol = 7)
                colnames(results38) <- c("Viereck.3", "Park", "Plot", "Sample_Year", 
                                                        "Viereck.3*Sample_YEar", "Residual", "Total")
                
                #loop 
                for (i in 1:nrow(perms38)) {
                  temp.data <- lichens_env_alpine[perms38[i, ], ]
                  temp <- adonis2(alpine_lichen_composition ~ Viereck.3 + Park + Plot + Sample_Year + Viereck.3*Sample_Year,
                                  data = temp.data,
                                  method = "bray",
                                  by = "terms",
                                  permutations = 0)
...
### Univeriate 
      ...
      #subclass model 
          ...
          perms40 <- rbind(1:nrow(alpine_env_nonvasc),
                         shuffleSet(n = nrow(alpine_env_nonvasc), control = perm_design_alpine_nonvasc_time, nset = 999))
          
          #create object for Ss to be stored 
          results40 <- matrix(nrow = nrow(perms40), ncol = 7)
          colnames(results40) <- c("Viereck.3", "Park", "Plot", "Sample_Year", 
                                 "Viereck.3*Sample_Year", "Residual", "Total")
...
#differences among subclasses 
        ...
        #create permutation object 
            perms42 <- rbind(1:nrow(alpine_nonvasc_composition),
                            shuffleSet(n = nrow(alpine_nonvasc_composition), control = perm_design_alpine_nonvasc_time, nset = 999))
        #create results object 
            results42 <- matrix(nrow = nrow(perms42), ncol = 7)
            colnames(results42) <- c("Viereck.3", "Park", "Plot", "Sample_Year", "Viereck.3*Sample_Year", "Residual", "Total")
