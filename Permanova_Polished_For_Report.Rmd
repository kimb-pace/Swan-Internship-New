...
summary_table_vasc <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/summary_table_vasc.xlsx")
summary_table_nonvasc <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/summary_table_nonvasc.xlsx")
summary_table_lichens <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/summary_table_lichens.xlsx")

vasc_df <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/vasc_df_balanced.xlsx")
nonvasc_df <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/nonvasc_df_balanced.xlsx")
lichens_df <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/lichens_df_balanced.xlsx")

lichen_sp_richness <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/Lichen_Species_Richness.xlsx")
nonvasc_sp_richness <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/Nonvascular_Species_Richness.xlsx")
vasc_sp_richness <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/Vascular_Species_Richness.xlsx")

lichens_env <- lichenspresence_absence_df[,c(1:12)]
nonvasc_env <- nonvascpresence_absence_df[,c(1:12)]
vasc_env <- vascpresence_absence_df[,c(1:10)]
...
lichens_env <- lichens_df[,c(1:12)]
nonvasc_env <- nonvasc_df[,c(1:12)]
vasc_env <- vasc_df[,c(1:10)]

viereck <- read_xlsx("T:/Users/KPace/SWAN-Internship/Viereck_env.xlsx")



dwarfscrub_env <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/dwarfscrub_env.xlsx")
dwarfscrub_env_lichens <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/dwarfscrub_env_lichens.xlsx")
dwarfscrub_env_nonvasc <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/dwarfscrub_env_nonvasc.xlsx")

dwarfscrub_df <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/dwarfscrub_df.xlsx")
dwarfscrub_df_lichens <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/dwarfscrub_df_lichens.xlsx")
dwarfscrub_df_nonvasc <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/dwarfscrub_df_nonvasc.xlsx")
...
alpine_df <- read_xlsx("T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/alpine_df.xlsx")
write_xlsx(alpine_env, "T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/alpine_env.xlsx")
...
#univariate analysis for species richness 
...
perms3 <- rbind(1:nrow(alpine_env),
...
#interaction of park and time for rest of table 
alpine_vascular_univariate_timecross3 <- adonis2(alpine_env$Species_Richness ~ Park + Plot + Visit + Park*Visit,
                                      data = alpine_env, 
                                      method = "euclidian",
                                      permutations = perm_design_alpine_time,
                                      by = "terms")
alpine_vascular_univariate_timecross3
...
perms4 <- rbind(1:nrow(alpine_composition),
...
alpine_vascular_multivariate_timecross3 <- adonis2(alpine_composition ~ Park + Plot + Visit + Park*Visit,
                                      data = alpine_env, 
                                      method = "euclidian",
                                      permutations = perm_design_alpine_time,
                                      by = "terms")
alpine_vascular_multivariate_timecross3
...
#create permutation object 
perms <- rbind(1:nrow(lichens_env_alpine),
...
for (i in 1:nrow(perms)) {
  temp.data <- lichens_env_alpine[perms[i, ], ]
...
alpine_lichen_univariate_timecross3 <- adonis2(lichens_env_alpine$Species_Richness ~ Park + Plot + Visit + Park*Visit,
                                      data = lichens_env_alpine, 
                                      method = "euclidian",
                                      permutations = perm_design_alpine_lichen_time,
                                      by = "terms")
alpine_lichen_univariate_timecross3
...
#create permutation object 
perms2 <- rbind(1:nrow(alpine_lichen_composition),
...
for (i in 1:nrow(perms2)) {
  temp.data <- lichens_env_alpine[perms2[i, ], ]
...
alpine_lichen_result_timecross3 <- adonis2(alpine_lichen_composition ~ Park + Plot + Visit + Park*Visit, 
                                  data = lichens_env_alpine, method = "bray", 
                                  permutations = perm_design_alpine_lichen_time, 
                                  by = "terms")
alpine_lichen_result_timecross3
...
write_xlsx(lichens_env_alpine, "T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/lichens_env_alpine.xlsx")
write_xlsx(alpine_lichen_df, "T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/alpine_lichen_df.xlsx")
...
write_xlsx(nonvasc_env_alpine, "T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/nonvasc_env_alpine.xlsx")
write_xlsx(alpine_nonvasc_df, "T:/Users/KPace/SWAN-Internship/Verified_Spreadsheets/alpine_nonvasc_df.xlsx")
...
write_xlsx(needle_env, "C:/Users/kmpace/Desktop/needle_env.xlsx")
write_xlsx(needle_env_lichen, "C:/Users/kmpace/Desktop/needle_env_lichen.xlsx")
write_xlsx(needle_env_nonvasc, "C:/Users/kmpace/Desktop/needle_env_nonvasc.xlsx")
```
...
#verify everything has two sample visits 
#table(openlow_df$Park, openlow_df$Plot)
#table(openlow_env$Park, openlow_env$Plot)
