...
```{r}
#Vascular 
    #hand select the years for plots with more than the decided number of visits, which is 3 in this case  
...
#Differences between parks 
  ...
  #hand calculate corrected F values 
      ...
      #create permutation object that determines how your data will be shuffled each time 
...
#Multivariate (species frequency)
  #differences between parks 
    ...
    #hand calculate corrected F values
      ...
      #create results object to store the sums of squares for each permutation 
...
#Vascular 
  ...
  #Species Richness (Univariate)
    #Differences between parks 
          ...
          #create object for SS to be stored from each permutation 
  ...
  ### Multivariate - species frequency
      #differences between parks 
          ...
          #create results object that stores sums of squares for each permutation 
      ...
      #differences through time 
          ...
          perms08 <- rbind(1:nrow(needle_composition),
                           shuffleSet(n = nrow(needle_composition), 
                                      control = perm_design_needle, nset = 999))
          #create results object that will store the sums of squares for each permutation 
        ...
        #differences between parks 
          ...
          perms12 <- rbind(1:nrow(needle_composition_nonvasc),
                           shuffleSet(n = nrow(needle_composition_nonvasc), 
                                      control = perm_design_needle_nonvasc, nset = 999))
          #create results object that will store the sums of squares from each permutation 
