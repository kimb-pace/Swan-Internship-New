...
forest_composition_lichen <- forest_df_lichen[,c(12:178)]
...
#Descriptive info for caption 
    length(unique(needle_df_lichens[["Plot"]])) #number of plots 
    mds_needle_lichens$stress #stress value 
    mds_needle_lichens$iters #number of iterations 
...
#plot with base overlay options
      ordiplot(mds_needle_lichens, type = "n", xlim = xlim, ylim = ylim, 
               cex.axis = 1.5, cex.lab = 1.4, main = "Lichen Species", cex.main = 2,
               xlab = "NMDS1", ylab = "NMDS2")
      text(x = par("usr")[1],
           y = par("usr")[4] - 0.1,
